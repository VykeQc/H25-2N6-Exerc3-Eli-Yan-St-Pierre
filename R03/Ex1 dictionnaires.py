...
modif = {"courriel": "2000000@cegepmontpetit.ca"}
etudiant.update(modif)
print(f"Voici le courriel de l'étudiant qui a été ajouté: {etudiant['courriel']}")
...
pop = etudiant.pop("age")
print(f"on a enlevé l'âge de l'étudiant, sa valeur était: {pop}")
...
lenght = len(etudiant)
print(f"Nous avons maintenant {lenght} paires clés valeurs")